...
const Page = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row m-10 gap-6">
      <div className="flex gap-6 flex-col md:flex-row">
        <div className="flex gap-6 flex-col">
          <div className="flex bg-primary_beige md:w-[27rem] h-[27rem] rounded-xl justify-center items-center">
      ...
      <div className="bg-primary_white w-full md:w-[27rem] h-[27rem] rounded-xl justify-center items-center flex">
